...
for n_hidden_nodes in set_of_number_of_nodes:
    ...
    absolute_residual_error_sin.append(np.mean(np.abs(testing_sin_points - rbf_sin_predictions)))
    absolute_residual_error_square.append(np.mean(np.abs(testing_square_points - rbf_square_predictions)))
